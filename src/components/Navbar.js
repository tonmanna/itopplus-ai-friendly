...
const navigation = [
  ...
  { name: "Submit Website", href: "/submit" },
        ...
        <>
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="space-y-1 pb-3 pt-2">
              ...
              <Link
                to="/auth/login"
                className="block border-l-4 border-transparent py-2 pl-3 pr-4 text-base font-medium text-indigo-600 hover:border-gray-300 hover:bg-gray-50"
              >
                Sign in
              </Link>
            </div>
